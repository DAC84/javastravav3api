...
import javastrava.api.club.ListRecentClubActivitiesTest;
import javastrava.api.util.ArrayCallback;
import api.issues.strava.Issue164;
import api.issues.strava.Issue166;
...
public class ListRecentClubActivitiesAsyncTest extends ListRecentClubActivitiesTest {
	...
	/**
	 * @see javastrava.api.club.ListRecentClubActivitiesTest#listCallback()
	 */
	@Override
	...
	/**
	 * @see javastrava.api.club.ListRecentClubActivitiesTest#pagingCallback()
	 */
	@Override
