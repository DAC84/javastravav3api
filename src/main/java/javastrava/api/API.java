...
/**
 * <p>
 * Provides a static method {@link #instance(Class, Token)} which constructs a standard retrofit javastrava.service with all the required options.
 * </p>
 *
 * @author Dan Shannon
 *
...
public class API {
	 ...
	 * @return A REST javastrava.service
	 */
	public static <T> T instance(final Class<T> class1, final Token token) {
		return new RestAdapter.Builder()
				...
				// Log level is determined per API javastrava.service
