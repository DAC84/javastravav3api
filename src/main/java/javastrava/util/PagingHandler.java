...
public class PagingHandler {
	...
	/**
	 * <p>
	 * Returns ALL the data from a Strava javastrava.service that would normally only return a page of data, by simply getting pages 1..n until there's no more data to retrieve
	 * </p>
	 *
	 * <p>
