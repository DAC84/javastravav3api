...
public class ActivityServiceImpl extends StravaServiceImpl implements ActivityService {
     ...
     */
    public ActivityServiceImpl(final API api) {
        super(api);
        this.activityCache = new StravaCacheImpl<>(StravaActivity.class, api.getToken());
        this.commentCache = new StravaCacheImpl<>(StravaComment.class, api.getToken());
        this.lapCache = new StravaCacheImpl<>(StravaLap.class, api.getToken());
        this.photoCache = new StravaCacheImpl<>(StravaPhoto.class, api.getToken());
    }
